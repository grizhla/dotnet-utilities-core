...
public class GrizhlaDBContext : DbContext
{
    ...
    public GrizhlaDBContext(DbContextOptions options, bool historyEnabled = true)
        : base(options)
    {
